...
public class EnquiryData extends Activity {

    String GET_SHOP = DataService.URL_ADMIN + "getenquiredcustomersbyshopname";
    String ALL_ENQUIRY_LIST = DataService.URL_ADMIN + "getenquiredcustomers";
    ...
    HashMap<String, HashMap<String,String>> newlistchild1;
    ArrayList<HashMap<String, String>> filter_customeradapt;
    ArrayList<String> newcount1;
...
*/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        newcount1 = new ArrayList<>();
        filter_customeradapt = new ArrayList<>();
        newlistchild1 = new HashMap<String,HashMap<String,String>>();
        ...
        dialog2 = new Dialog(EnquiryData.this);
        ...
        if (Util.Operations.isOnline(EnquiryData.this)) {
                    ...
                    if (data.length() > 0) {
                        ...
                        for (int i1 = 0; i1 < data.length(); i1++) {
                            ...
                            for (int u = 0; u < customerdetails.length(); u++) {
                                ...
                                map.put("comments", user_obj.getString("comments"));
                                Log.e("tag", "04" + user_obj.getString("comments"));
                        ...
                        listAdapter = new ExpandableListAdapter_enquiry(EnquiryData.this, list_childName, ar_count);
        ...
        protected void onPostExecute(String jsonStr) {
            ...
            try {
                ...
                if (status.equals("true")) {
                    ...
                    JSONArray shop_list = jsonObject.getJSONArray("enquiry");
                    ...
                    else
                    {
                        ...
                        for(int r =0;r<shop_list.length();r++){
                            ...
                            map1.put("comments", shop_obj.getString("comments"));
                            Log.e("tag", "04" + shop_obj.getString("comments"));
                            ...
                            newlistchild1.put(String.valueOf(r),map1);
                            newcount1.add(String.valueOf(r));
                        }
                ...
                listAdapter = new ExpandableListAdapter_enquiry(EnquiryData.this,newlistchild1,newcount1);
