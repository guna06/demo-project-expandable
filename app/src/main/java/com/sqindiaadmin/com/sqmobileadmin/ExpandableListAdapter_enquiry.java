...
class ExpandableListAdapter_enquiry extends BaseExpandableListAdapter{
    ...
    public ExpandableListAdapter_enquiry(Context context, HashMap<String, HashMap<String,String>> map, List<String> count) {
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
      ...
      Typeface tf = Typeface.createFromAsset(context.getAssets(), "helvatica.TTF");
        if (convertView == null) {
            ...
            LayoutInflater infalInflater = (LayoutInflater) this.context
                    .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            convertView = infalInflater.inflate(R.layout.enquiry_child_view, null);
        }
